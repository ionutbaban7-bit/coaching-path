...
var CORE = [
  ...
  'assets/css/academy.css?v=4.3.0', 'assets/css/hub.css?v=4.3.0', 'assets/css/old-money.css?v=4.3.0', 'assets/css/journal.css?v=4.3.0', 'assets/js/academy-data.js?v=4.3.0', 'assets/js/academy.js?v=4.3.0',
  'assets/js/hub.js?v=4.3.0', 'assets/js/forum.js?v=4.3.0', 'assets/js/start-content.js?v=4.3.0',
  'assets/img/academy-conversation.webp?v=4.3.0', 'assets/img/academy-library.webp?v=4.3.0',
  './',
  'certificari.html',
  'traseul-meu.html',
  'scoli.html',
  'resurse.html',
  'invata.html',
  'assets/css/atlas.css?v=4.3.0',
  'assets/js/atlas.js?v=4.3.0',
  'index.html',
  'hub.html',
  'forum.html',
  'incepe.html',
  ...
  e.waitUntil(
    caches.open(CACHE_VERSION).then(function(c){
      ...
      return Promise.all(CORE.map(function(u){
        return c.add(new Request(/\.(css|js)$/.test(u) ? u + '?v=4.3.0' : u, { cache:'reload' })).catch(function(){});
      }));
