...
var CORE = [
  ...
  'assets/css/learning.css?v=4.4.2','assets/js/learning.js?v=4.4.2',
  'descopera.html', 'competente.html', 'povesti.html', 'intrebari.html', 'greseli.html',
  'assets/css/academy.css?v=4.4.2', 'assets/css/hub.css?v=4.4.2', 'assets/css/old-money.css?v=4.4.2', 'assets/css/journal.css?v=4.4.2', 'assets/js/academy-data.js?v=4.4.2', 'assets/js/academy.js?v=4.4.2',
  'assets/js/hub.js?v=4.4.2', 'assets/js/forum.js?v=4.4.2', 'assets/js/start-content.js?v=4.4.2',
  'assets/img/academy-conversation.webp?v=4.4.2', 'assets/img/academy-library.webp?v=4.4.2',
  './',
  'certificari.html',
  'traseul-meu.html',
  'scoli.html',
  'resurse.html',
  'invata.html',
  'assets/css/atlas.css?v=4.4.2',
  'assets/js/atlas.js?v=4.4.2',
  'index.html',
  'hub.html',
  'forum.html',
  'incepe.html',
  ...
  e.waitUntil(
    caches.open(CACHE_VERSION).then(function(c){
      ...
      return Promise.all(CORE.map(function(u){
        return c.add(new Request(/\.(css|js)$/.test(u) ? u + '?v=4.4.2' : u, { cache:'reload' })).catch(function(){});
      }));
